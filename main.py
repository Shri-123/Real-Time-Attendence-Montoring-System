# https://www.fotor.com/photo-editor-app/editor/basic // TO ADD IMAGES RESIZE HERE FOR 216 x 216
...
while True:
    ...
    if faceCurFrame:
        for encoFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            ...
            # print("Minimum MatchIndex of face : ", matchIndex)
            ...
            if matches[matchIndex]:
                ...
                imgBackground = cvzone.cornerRect(imgBackground, bbox, rt=0) # rt = thickness something
                id = studentIDs[matchIndex]
                if counter == 0:
                    cvzone.putTextRect(imgBackground, "Loading", (275, 400))
                    cv2.imshow("Face attendence background",  imgBackground)
                    cv2.waitKey(1)
                    counter = 1
                    modeType = 1
    ...
    # cv2.imshow("Face attendence window", img)
    cv2.imshow("Face attendence background", imgBackground)
    cv2.waitKey(1)